...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            List<WebElement> addressToSelectElement = driver.findElements(By
                    .xpath("//div[@class='address-item not-selected MuiBox-root css-0']/div[1]/p"));
            for (int i = 0; i < addressToSelectElement.size(); i++) {
                WebElement addressText = addressToSelectElement.get(i);
                String actualAddressText = addressText.getText();

...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            // box
            //// div[contains(@class,'search-desktop')]//input[@name='search']
            WebElement searchBox = driver.findElement(By.xpath("(//*[@name='search'])[1]"));
            searchBox.clear();
            searchBox.sendKeys(product);

            WebDriverWait wait = new WebDriverWait(driver, 30);
            // wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.className("css-yg30ev6"),
            // product),
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver.findElement(By.xpath("//*[text()=' No products found ']"))
                    .isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            // WebElement cartParent = driver.findElement(By.className(
            // "MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-3 css-1q5pok1"));
